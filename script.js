...
(function () {
  ...
  const activists = {
    ...
    autumn: {
      ...
      sub: "The Water Protector.",
      story: "Autumn Peltier is an Anishinaabe activist from Canada who has fought for clean drinking water since she was eight years old. Many First Nations communities have gone years without safe tap water, and Peltier treats water access as a basic human right and a climate justice issue. At thirteen, she addressed the United Nations, and in 2019 she became Chief Water Commissioner for the Anishinabek Nation.",
      problem: "Indigenous communities denied clean, safe water.",
      tactics: ["UN and world-stage speeches", "Water protection advocacy", "Representing First Nations", "Carrying on Indigenous water-protection traditions"],
      impact: "Made Indigenous water rights a global climate justice issue.",
      sources: ["CNN, “Autumn Peltier: Meet the ‘Water Protector’ of Canada’s First Nations”", "The Canadian Encyclopedia, “Autumn Peltier”"],
    },
    sophia: {
      title: "Sophia Kianni",
      sub: "Closing the Climate Language Gap.",
      story: "Sophia Kianni is an Iranian-American climate activist who realized most climate science exists only in English, leaving many people unable to understand the crisis in their own language. At seventeen, she founded Climate Cardinals, a youth-led climate education organization focused on translating climate information. Her work shows that climate justice also means access to knowledge.",
      problem: "Many communities cannot access climate information in their own language.",
      tactics: ["Translation", "Climate education", "Youth chapters", "Digital organizing", "Language-access advocacy"],
      impact: "Helped make climate education more accessible to non-English-speaking communities.",
      sources: ["Climate Cardinals, “Why Climate Cardinals?”", "Newsweek, “Sophia Kianni: Spreading the Word on Climate Change 100 Ways”"],
    },
  };
  ...
  /* ----------------------------------------------------------
     ...
     ---------------------------------------------------------- */
  const roleData = {
    organizer:  { you: "You bring people together.", step: "Start or join a school climate club and plan one awareness event." },
    researcher: { you: "You use facts to make the issue clear.", step: "Research one local climate justice problem and create a one-page fact sheet." },
    speaker:    { you: "You use your voice to create pressure.", step: "Speak at a school, club, or local meeting about one climate justice issue." },
    designer:   { you: "You make the movement visible.", step: "Create a poster, infographic, or short campaign about climate justice." },
    policy:     { you: "You focus on systems and laws.", step: "Email a local official asking for youth input in climate decisions." },
    translator: { you: "You make information accessible.", step: "Translate one climate resource into a language your community uses." },
  };
